...
<form method="post" action="/user/profile" class="col-lg-4">
    ...
    <div class="form-group">
        ...
        <input type="email" name="email" class="form-control validate" id="email" placeholder="Email" data-rule="email" value="<?= $user->email?>" required>
    </div>
    <div class="form-group">
